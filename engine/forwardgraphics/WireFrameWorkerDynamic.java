...
/*
public class WireFrameWorkerDynamic implements Runnable {
	Camera cam;
	...
	public WireFrameWorkerDynamic (Camera cam, WritableRaster raster, ModelGroup group, int start, int end)
	{
		this.group = group;
