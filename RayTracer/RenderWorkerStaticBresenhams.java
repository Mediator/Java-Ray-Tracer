...
public class RenderWorkerStaticBresenhams implements Runnable {
	...
	int start;
	int end;
	public RenderWorkerStaticBresenhams (Camera cam,ImageWrapper tIW,double [][] zData, ModelGroup group, int start, int end)
	{
...
/*
	    ...
	    private boolean isInsideEdge(int x, int y, int edgeID) {
	        switch (edgeID) {
	            case 0:
	                return y >= cam.minY;
	            case 2:
